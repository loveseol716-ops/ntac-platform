...
export async function loadTodayCheckin() {
  ...
  return normalizeCheckin(data[0])
}
...
export async function saveWorkoutRecord(
  ...
  const payload = {
    ...
    title:
      calendarInfo.title || null,

    workout_type:
      calendarInfo.type || null,
  ...
  return normalizeWorkoutRecord(data)
}
